...
namespace SPapi.NET
{
    public class SpClient
    {
        ...
        {
            var route = "https://sp-api.ru/spm/online";
        ...
        {
            var route = "https://sp-api.ru/spm/chat";
        ...
        {
            var route = "https://sp-api.ru/spm/time";
        ...
        {
            var route = "https://sp-api.ru/spm/weather";
